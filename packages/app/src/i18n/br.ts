export const dict = {
  ...
  "desktop.updater.dialog.available.title": "Atualização disponível ({{version}})",
  ...
  "desktop.updater.dialog.upToDate.message": "Você está em dia. ({{version}})",
  ...
  "session.new.hero.title": "Descreva sua ideia. Comece a criar.",
