export const dict = {
  ...
  "desktop.updater.dialog.available.title": "Frissítés elérhető ({{version}})",
  "desktop.menu.app": "OpenCode",
  "desktop.menu.file": "Fájl",
  "desktop.menu.edit": "Szerkesztés",
  "desktop.menu.view": "Nézet",
  "desktop.menu.go": "Ugrás",
  "desktop.menu.window": "Ablak",
  "desktop.menu.help": "Súgó",
  "desktop.menu.checkForUpdates": "Frissítések keresése...",
  "desktop.menu.settings": "Beállítások",
  "desktop.menu.reloadWebview": "Webview újratöltése",
  "desktop.menu.restart": "Újraindítás",
  "desktop.menu.exportLogs": "Naplók exportálása...",
  "desktop.menu.newSession": "Új munkamenet",
  "desktop.menu.openProject": "Projekt megnyitása...",
  "desktop.menu.newWindow": "Új ablak",
  "desktop.menu.closeWindow": "Ablak bezárása",
  "desktop.menu.undo": "Visszavonás",
  "desktop.menu.redo": "Újra",
  "desktop.menu.cut": "Kivágás",
  "desktop.menu.copy": "Másolás",
  "desktop.menu.paste": "Beillesztés",
  "desktop.menu.delete": "Törlés",
  "desktop.menu.selectAll": "Összes kijelölése",
  "desktop.menu.toggleSidebar": "Oldalsáv ki- és bekapcsolása",
  "desktop.menu.toggleTerminal": "Terminál ki- és bekapcsolása",
  "desktop.menu.toggleFileTree": "Fájlfastruktúra ki- és bekapcsolása",
  "desktop.menu.reload": "Újratöltés",
  "desktop.menu.toggleDeveloperTools": "Fejlesztői eszközök ki- és bekapcsolása",
  "desktop.menu.actualSize": "Valódi méret",
  "desktop.menu.zoomIn": "Nagyítás",
  "desktop.menu.zoomOut": "Kicsinyítés",
  "desktop.menu.toggleFullScreen": "Teljes képernyő ki- és bekapcsolása",
  "desktop.menu.back": "Vissza",
  "desktop.menu.forward": "Előre",
  "desktop.menu.previousSession": "Előző munkamenet",
  "desktop.menu.nextSession": "Következő munkamenet",
  "desktop.menu.previousProject": "Előző projekt",
  "desktop.menu.nextProject": "Következő projekt",
  "desktop.menu.minimize": "Kis méret",
  "desktop.menu.maximize": "Teljes méret",
  "desktop.menu.documentation": "OpenCode dokumentáció",
  "desktop.menu.supportForum": "Támogatási fórum",
  "desktop.menu.shareFeedback": "Visszajelzés küldése",
  "desktop.menu.reportBug": "Hiba jelentése",
  "desktop.menu.ariaLabel": "OpenCode menü",
  "desktop.updater.dialog.checkFailed.message": "A frissítések keresése sikertelen.",
  "desktop.updater.dialog.checkFailed.title": "Frissítési hiba",
  "desktop.updater.dialog.upToDate.message": "A legfrissebb verziót használja. ({{version}})",
  "desktop.updater.dialog.upToDate.title": "Nincs frissítés",
  "desktop.updater.dialog.ready.message": "A(z) {{version}} frissítés letöltődött. Újraindítja most?",
  "desktop.updater.dialog.ready.title": "A frissítés készen áll",
  "desktop.updater.dialog.restart": "Újraindítás",
  "desktop.updater.dialog.later": "Később",
  "desktop.recovery.action.relaunch": "Újraindítás",
  "desktop.recovery.action.exportLogs": "Naplók exportálása",
  "desktop.recovery.action.keepWaiting": "Várakozás folytatása",
  "desktop.recovery.action.quit": "Kilépés",
  "desktop.recovery.loadFailed": "Az OpenCode betöltése sikertelen",
  "desktop.recovery.terminated": "Az OpenCode ablaka váratlanul leállt",
  "desktop.recovery.unresponsive": "Az OpenCode nem válaszol",
  "desktop.recovery.unresponsive.detail":
    "Újraindíthatja az alkalmazást, megnyithatja a naplókat, vagy folytathatja a várakozást.",
  "desktop.recovery.loadFailed.detail": "Ablak: {{window}}\nURL: {{url}}\nHiba: {{code}} {{description}}",
  "desktop.recovery.terminated.detail": "Ablak: {{window}}\nOk: {{reason}}\nKód: {{code}}",
  "desktop.recovery.unknown": "<ismeretlen>",
  "desktop.dialog.chooseFolder": "Mappa kiválasztása",
  "desktop.dialog.chooseFile": "Fájl kiválasztása",
  "desktop.dialog.saveFile": "Fájl mentése",
  "desktop.dialog.files": "Fájlok",
  "desktop.server.local": "Helyi kiszolgáló",
  "desktop.wsl.error.windowsOnly": "A WSL csak Windows rendszeren érhető el",
  "desktop.wsl.error.unavailable": "A WSL nem érhető el",
  "desktop.wsl.error.listInstalled": "A telepített WSL-disztribúciók felsorolása sikertelen",
  "desktop.wsl.error.listOnline": "Az online WSL-disztribúciók felsorolása sikertelen",
  "desktop.wsl.error.executeDistro": "Nem hajthatók végre parancsok a disztribúcióban",
  "desktop.wsl.error.installWsl": "A WSL telepítése sikertelen",
  "desktop.wsl.error.installDistro": "A disztribúció telepítése sikertelen: {{distro}}",
  "desktop.wsl.error.installOpencode": "Az OpenCode telepítése sikertelen",
  "desktop.wsl.error.alreadyAdded": "A(z) {{distro}} már hozzá van adva",
  "desktop.wsl.error.opencodeMissing": "Az opencode nincs telepítve ebben a disztribúcióban",
  "desktop.wsl.error.opencodeCannotRun": "Az opencode telepítve van, de nem futtatható",
  "desktop.wsl.error.opencodeNotInstalled": "Az OpenCode nincs telepítve ebben: {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Az OpenCode frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "desktop.wsl.error.noVersion": "nincs verzió",
  "desktop.wsl.error.serverExited": "A WSL-kiszolgáló indítás után kilépett (code={{code}} signal={{signal}})",
  ...
  "desktop.wsl.error.failedPort": "A port lekérése sikertelen",
  "desktop.picker.error.notSelected": "A fájl nem lett kiválasztva a választóban",
  "desktop.picker.error.sizeLimit": "A kiválasztott mellékletek meghaladják a(z) {{limit}} MB-os korlátot",
