export const dict = {
  ...
  "desktop.updater.dialog.available.title": "Uppfærsla í boði ({{version}})",
  "desktop.menu.app": "OpenCode",
  "desktop.menu.file": "Skrá",
  "desktop.menu.edit": "Breyta",
  "desktop.menu.view": "Skoða",
  "desktop.menu.go": "Fara",
  "desktop.menu.window": "Gluggi",
  "desktop.menu.help": "Hjálp",
  "desktop.menu.checkForUpdates": "Leita að uppfærslum...",
  "desktop.menu.settings": "Stillingar",
  "desktop.menu.reloadWebview": "Endurhlaða Webview",
  "desktop.menu.restart": "Endurræsa",
  "desktop.menu.exportLogs": "Flytja út atvikaskrár...",
  "desktop.menu.newSession": "Ný seta",
  "desktop.menu.openProject": "Opna verkefni...",
  "desktop.menu.newWindow": "Nýr gluggi",
  "desktop.menu.closeWindow": "Loka glugga",
  "desktop.menu.undo": "Afturkalla",
  "desktop.menu.redo": "Endurtaka",
  "desktop.menu.cut": "Klippa",
  "desktop.menu.copy": "Afrita",
  "desktop.menu.paste": "Líma",
  "desktop.menu.delete": "Eyða",
  "desktop.menu.selectAll": "Velja allt",
  "desktop.menu.toggleSidebar": "Víxla hliðarstiku",
  "desktop.menu.toggleTerminal": "Víxla skjáhermi",
  "desktop.menu.toggleFileTree": "Víxla skráartré",
  "desktop.menu.reload": "Endurhlaða",
  "desktop.menu.toggleDeveloperTools": "Víxla forritaraverkfærum",
  "desktop.menu.actualSize": "Raunstærð",
  "desktop.menu.zoomIn": "Auka aðdrátt",
  "desktop.menu.zoomOut": "Minnka aðdrátt",
  "desktop.menu.toggleFullScreen": "Víxla öllum skjánum",
  "desktop.menu.back": "Til baka",
  "desktop.menu.forward": "Áfram",
  "desktop.menu.previousSession": "Fyrri seta",
  "desktop.menu.nextSession": "Næsta seta",
  "desktop.menu.previousProject": "Fyrra verkefni",
  "desktop.menu.nextProject": "Næsta verkefni",
  "desktop.menu.minimize": "Lágmarka",
  "desktop.menu.maximize": "Hámarka",
  "desktop.menu.documentation": "OpenCode skjölun",
  "desktop.menu.supportForum": "Aðstoðarspjallborð",
  "desktop.menu.shareFeedback": "Deila ábendingu",
  "desktop.menu.reportBug": "Tilkynna villu",
  "desktop.menu.ariaLabel": "OpenCode-valmynd",
  "desktop.updater.dialog.checkFailed.message": "Athugun á uppfærslu mistókst.",
  "desktop.updater.dialog.checkFailed.title": "Villa í uppfærslu",
  "desktop.updater.dialog.upToDate.message": "Þú ert með nýjustu útgáfuna. ({{version}})",
  "desktop.updater.dialog.upToDate.title": "Engar uppfærslur",
  "desktop.updater.dialog.ready.message": "Uppfærsla {{version}} sótt. Endurræsa núna?",
  "desktop.updater.dialog.ready.title": "Uppfærsla tilbúin",
  "desktop.updater.dialog.restart": "Endurræsa",
  "desktop.updater.dialog.later": "Seinna",
  "desktop.recovery.action.relaunch": "Endurræsa forrit",
  "desktop.recovery.action.exportLogs": "Flytja út atvikaskrár",
  "desktop.recovery.action.keepWaiting": "Bíða áfram",
  "desktop.recovery.action.quit": "Hætta",
  "desktop.recovery.loadFailed": "Ekki tókst að hlaða OpenCode",
  "desktop.recovery.terminated": "OpenCode-glugganum var óvænt lokað",
  "desktop.recovery.unresponsive": "OpenCode svarar ekki",
  "desktop.recovery.unresponsive.detail": "Þú getur endurræst forritið, opnað atvikaskrárnar eða haldið áfram að bíða.",
  "desktop.recovery.loadFailed.detail": "Gluggi: {{window}}\nSlóð: {{url}}\nVilla: {{code}} {{description}}",
  "desktop.recovery.terminated.detail": "Gluggi: {{window}}\nÁstæða: {{reason}}\nKóði: {{code}}",
  "desktop.recovery.unknown": "<óþekkt>",
  "desktop.dialog.chooseFolder": "Veldu möppu",
  "desktop.dialog.chooseFile": "Veldu skrá",
  "desktop.dialog.saveFile": "Vista skrá",
  "desktop.dialog.files": "Skrár",
  "desktop.server.local": "Staðbundinn þjónn",
  "desktop.wsl.error.windowsOnly": "WSL er aðeins í boði á Windows",
  "desktop.wsl.error.unavailable": "WSL er ekki í boði",
  "desktop.wsl.error.listInstalled": "Ekki tókst að telja upp uppsettar WSL-dreifingar",
  "desktop.wsl.error.listOnline": "Ekki tókst að telja upp WSL-dreifingar á netinu",
  "desktop.wsl.error.executeDistro": "Ekki er hægt að keyra skipanir í dreifingu",
  "desktop.wsl.error.installWsl": "Uppsetning WSL mistókst",
  "desktop.wsl.error.installDistro": "Uppsetning dreifingar mistókst: {{distro}}",
  "desktop.wsl.error.installOpencode": "Uppsetning OpenCode mistókst",
  "desktop.wsl.error.alreadyAdded": "{{distro}} hefur þegar verið bætt við",
  "desktop.wsl.error.opencodeMissing": "opencode er ekki uppsett í þessari dreifingu",
  "desktop.wsl.error.opencodeCannotRun": "opencode er uppsett en ekki var hægt að keyra það",
  "desktop.wsl.error.opencodeNotInstalled": "OpenCode er ekki uppsett í {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Uppfærslu OpenCode lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "desktop.wsl.error.noVersion": "engin útgáfa",
  "desktop.wsl.error.serverExited": "WSL-þjónn hætti eftir ræsingu (code={{code}} signal={{signal}})",
  ...
  "desktop.wsl.error.commandTimeout": "Tímamörk {{command}} {{args}} runnu út eftir {{timeout}} ms",
  "desktop.wsl.error.failedPort": "Ekki tókst að sækja gátt",
  "desktop.picker.error.notSelected": "Skráin var ekki valin í skráavalinu",
  "desktop.picker.error.sizeLimit": "Valin viðhengi fara yfir {{limit}} MB hámarkið",
