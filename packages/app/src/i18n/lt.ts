export const dict = {
  "settings.updates.action.download": "Atsiųsti",
  "desktop.updater.dialog.download": "Atsiųsti",
  "desktop.updater.dialog.available.message": "Dabar galima įdiegti naują OpenCode versiją.",
  "desktop.updater.dialog.available.title": "Galimas atnaujinimas ({{version}})",
  "desktop.menu.app": "OpenCode",
  "desktop.menu.file": "Failas",
  "desktop.menu.edit": "Taisa",
  "desktop.menu.view": "Rodymas",
  "desktop.menu.go": "Eiti",
  "desktop.menu.window": "Langas",
  "desktop.menu.help": "Žinynas",
  "desktop.menu.checkForUpdates": "Tikrinti, ar yra naujinimų...",
  "desktop.menu.settings": "Nuostatos",
  "desktop.menu.reloadWebview": "Įkelti Webview iš naujo",
  "desktop.menu.restart": "Paleisti iš naujo",
  "desktop.menu.exportLogs": "Eksportuoti žurnalus...",
  "desktop.menu.newSession": "Naujas seansas",
  "desktop.menu.openProject": "Atverti projektą...",
  "desktop.menu.newWindow": "Naujas langas",
  "desktop.menu.closeWindow": "Užverti langą",
  "desktop.menu.undo": "Atšaukti",
  "desktop.menu.redo": "Pakartoti",
  "desktop.menu.cut": "Iškirpti",
  "desktop.menu.copy": "Kopijuoti",
  "desktop.menu.paste": "Įdėti",
  "desktop.menu.delete": "Pašalinti",
  "desktop.menu.selectAll": "Pažymėti viską",
  "desktop.menu.toggleSidebar": "Rodyti arba slėpti parankinę",
  "desktop.menu.toggleTerminal": "Rodyti arba slėpti terminalą",
  "desktop.menu.toggleFileTree": "Rodyti arba slėpti failų medį",
  "desktop.menu.reload": "Įkelti iš naujo",
  "desktop.menu.toggleDeveloperTools": "Rodyti arba slėpti programavimo priemones",
  "desktop.menu.actualSize": "Tikras dydis",
  "desktop.menu.zoomIn": "Padidinti",
  "desktop.menu.zoomOut": "Sumažinti",
  "desktop.menu.toggleFullScreen": "Rodyti arba slėpti visą ekraną",
  "desktop.menu.back": "Atgal",
  "desktop.menu.forward": "Pirmyn",
  "desktop.menu.previousSession": "Ankstesnis seansas",
  "desktop.menu.nextSession": "Kitas seansas",
  "desktop.menu.previousProject": "Ankstesnis projektas",
  "desktop.menu.nextProject": "Kitas projektas",
  "desktop.menu.minimize": "Suskleisti",
  "desktop.menu.maximize": "Išskleisti",
  "desktop.menu.documentation": "OpenCode dokumentacija",
  "desktop.menu.supportForum": "Pagalbos forumas",
  "desktop.menu.shareFeedback": "Pateikti atsiliepimą",
  "desktop.menu.reportBug": "Pranešti apie klaidą",
  "desktop.menu.ariaLabel": "OpenCode meniu",
  "desktop.updater.dialog.checkFailed.message": "Naujinių patikrinti nepavyko.",
  "desktop.updater.dialog.checkFailed.title": "Naujinimo klaida",
  "desktop.updater.dialog.upToDate.message": "Naudojate naujausią versiją. ({{version}})",
  "desktop.updater.dialog.upToDate.title": "Naujinių nėra",
  "desktop.updater.dialog.ready.message": "Naujinimas {{version}} parsiųstas. Paleisti iš naujo dabar?",
  "desktop.updater.dialog.ready.title": "Naujinimas paruoštas",
  "desktop.updater.dialog.restart": "Paleisti iš naujo",
  "desktop.updater.dialog.later": "Vėliau",
  "desktop.recovery.action.relaunch": "Paleisti iš naujo",
  "desktop.recovery.action.exportLogs": "Eksportuoti žurnalus",
  "desktop.recovery.action.keepWaiting": "Laukti toliau",
  "desktop.recovery.action.quit": "Baigti darbą",
  "desktop.recovery.loadFailed": "OpenCode įkelti nepavyko",
  "desktop.recovery.terminated": "OpenCode langas netikėtai užsidarė",
  "desktop.recovery.unresponsive": "OpenCode neatsako",
  "desktop.recovery.unresponsive.detail": "Galite paleisti programą iš naujo, atverti žurnalus arba laukti toliau.",
  "desktop.recovery.loadFailed.detail": "Langas: {{window}}\nURL: {{url}}\nKlaida: {{code}} {{description}}",
  "desktop.recovery.terminated.detail": "Langas: {{window}}\nPriežastis: {{reason}}\nKodas: {{code}}",
  "desktop.recovery.unknown": "<nežinoma>",
  "desktop.dialog.chooseFolder": "Pasirinkite aplanką",
  "desktop.dialog.chooseFile": "Pasirinkite failą",
  "desktop.dialog.saveFile": "Įrašyti failą",
  "desktop.dialog.files": "Failai",
  "desktop.server.local": "Vietinis serveris",
  "desktop.wsl.error.windowsOnly": "WSL veikia tik sistemoje Windows",
  "desktop.wsl.error.unavailable": "WSL nepasiekiamas",
  "desktop.wsl.error.listInstalled": "Nepavyko išvardyti įdiegtų WSL distributyvų",
  "desktop.wsl.error.listOnline": "Nepavyko išvardyti internete pasiekiamų WSL distributyvų",
  "desktop.wsl.error.executeDistro": "Negalima vykdyti komandų distributyve",
  "desktop.wsl.error.installWsl": "WSL įdiegti nepavyko",
  "desktop.wsl.error.installDistro": "Nepavyko įdiegti distributyvo: {{distro}}",
  "desktop.wsl.error.installOpencode": "OpenCode įdiegti nepavyko",
  "desktop.wsl.error.alreadyAdded": "{{distro}} jau pridėtas",
  "desktop.wsl.error.opencodeMissing": "opencode šiame distributyve neįdiegtas",
  "desktop.wsl.error.opencodeCannotRun": "opencode įdiegtas, bet jo paleisti nepavyko",
  "desktop.wsl.error.opencodeNotInstalled": "OpenCode neįdiegtas distributyve {{distro}}",
  "desktop.wsl.error.updateVersion":
    "OpenCode naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "desktop.wsl.error.noVersion": "versijos nėra",
  "desktop.wsl.error.serverExited": "WSL serveris užsidarė po paleidimo (code={{code}} signal={{signal}})",
  ...
  "desktop.wsl.error.commandTimeout": "Baigėsi komandai {{command}} {{args}} skirtas {{timeout}} ms laikas",
  "desktop.wsl.error.failedPort": "Nepavyko gauti prievado",
  "desktop.picker.error.notSelected": "Failas nebuvo pasirinktas failų parinkiklyje",
  "desktop.picker.error.sizeLimit": "Pasirinkti priedai viršija {{limit}} MB ribą",
