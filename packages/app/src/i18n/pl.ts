export const dict = {
  ...
  "desktop.updater.dialog.available.title": "Dostępna aktualizacja ({{version}})",
  ...
  "desktop.updater.dialog.upToDate.message": "Masz najnowszą wersję. ({{version}})",
  ...
  "session.new.hero.title": "Opisz swój pomysł. Zacznij tworzyć.",
