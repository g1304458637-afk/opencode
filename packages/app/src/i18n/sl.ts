export const dict = {
  ...
  "desktop.updater.dialog.available.title": "Na voljo je posodobitev ({{version}})",
  ...
  "desktop.updater.dialog.upToDate.message": "Ste na tekočem. ({{version}})",
  ...
  "session.new.hero.title": "Opišite svojo idejo. Začnite ustvarjati.",
