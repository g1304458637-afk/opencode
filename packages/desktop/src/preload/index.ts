...
const api: ElectronAPI = {
  ...
  mucGetUpdate: () => ipcRenderer.invoke("muc:get-update"),
  mucOpenDownloadPage: () => ipcRenderer.invoke("muc:open-download-page"),
  mucResetCard: (subscriptionId: number) => ipcRenderer.invoke("muc:reset-card", subscriptionId),
  mucGetBrand: () => ipcRenderer.invoke("muc:get-brand"),
  mucOpenAccount: () => ipcRenderer.invoke("muc:open-account"),
  mucAcknowledgeReset: (id, operationId) => ipcRenderer.invoke("muc:acknowledge-reset", id, operationId),
  mucOpenPricing: () => ipcRenderer.invoke("muc:open-pricing"),
