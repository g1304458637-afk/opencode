  ...
  return (
    <div class={`relative size-full flex flex-col gap-0 ${props.class ?? ""}`}>
      ...
      >
        ...
        <div data-slot="prompt-editor" class="relative min-h-[60px]">
          <div
            ref={(element) => {
              editor = element
        ...
        <div data-slot="prompt-toolbar" class="flex h-11 items-center px-2">
          <div
  ...
  return (
    ...
    >
      <IconButton
        ...
        style={{
          "background-image":
            "var(--prompt-submit-background, linear-gradient(180deg,var(--v2-alpha-light-20) 0%,var(--v2-alpha-light-0) 100%),linear-gradient(90deg,var(--v2-background-bg-contrast) 0%,var(--v2-background-bg-contrast) 100%))",
        }}
